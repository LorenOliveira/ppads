...
<header> 
	...
	div.pub input {border-radius: 3px; background-color: #000000; border:none; color: #FFF; height: 25px; padding-right: 5px; padding-left: 5px; cursor: pointer;}
	div.pub input:hover {background-color: #FFF; color: #000000;}
	</style>
</header>
<body>
	<br />
